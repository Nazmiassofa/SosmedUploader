...
class Settings:
    ...
    INSTAGRAM_ACCESS_TOKEN: str = os.getenv("INSTAGRAM_ACCESS_TOKEN") or os.getenv("PAGE_ACCESS_TOKEN", "")
    FACEBOOK_PAGE_ID: str = os.getenv("FACEBOOK_PAGE_ID", "")
    FACEBOOK_ACCESS_TOKEN: str = os.getenv("FACEBOOK_ACCESS_TOKEN") or os.getenv("PAGE_ACCESS_TOKEN", "")
    ...
    R2_BASE_URL: str = os.getenv("R2_BASE_URL", "https://media.mailezz.com")
